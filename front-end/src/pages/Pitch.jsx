...
//     formData.append("category", pitchData.category);
//     formData.append("description", pitchData.description);
//     formData.append("videoLink", pitchData.videoLink);
//     formData.append("pdfLink", pitchData.pdfLink);
//     formData.append("fundsRequired", pitchData.fundsRequired);
//     formData.append("estimatedProfit", pitchData.estimatedProfit);

  
//     if (pitchData.image) {
//       formData.append("image", pitchData.image);
//     }
//     if (pitchData.pptFile) {
//       formData.append("pptFile", pitchData.pptFile);
//     }
...
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="name">
//               Project Idea Name
//             </label>
//             <input
//               type="text"
...
//               placeholder="Enter your project idea name"
//               required
//             />
//           </div>

//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="category">
//               Project Category
//             </label>
//             <select
//               id="category"
...
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="description">
...
//           {/* Image Upload */}
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="image">
//               Upload an Image for Your Idea
//             </label>
//             <input
//               type="file"
//               id="image"
...
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="videoLink">
...
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="pdfLink">
...
//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="fundsRequired">
//               Funds Required
//             </label>
//             <input
//               type="number"
//               id="fundsRequired"
//               name="fundsRequired"
//               value={pitchData.fundsRequired}
//               onChange={handleChange}
//               className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//               placeholder="Enter the amount of funds required"
//               required
//             />
//           </div>

//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="estimatedProfit">
//               Estimated Profit
//             </label>
//             <input
//               type="number"
...
//               value={pitchData.estimatedProfit}
//               onChange={handleChange}
//               className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//               placeholder="Enter the estimated profit"
//               required
//             />
//           </div>

//           <div className="mb-6">
//             <label className="block text-xl font-semibold text-gray-700 mb-2" htmlFor="pptFile">
//               Upload PPT for Your Idea (Optional)
//             </label>
//             <input
//               type="file"
//               id="pptFile"
